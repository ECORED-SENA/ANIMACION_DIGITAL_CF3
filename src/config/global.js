export default {
  global: {
    ...
    descripcionCurso:
      'Antes de abandonar la fase de desarrollo y pasar a la pre-producción de un proyecto audiovisual, es imperativo validar que lo planteado en el guión técnico y el storyboard logran contar adecuadamente la historia creada en el guión literario. El mejor camino para realizar esta evaluación e identificar posibles ajustes, es la realización de una animatic o animática.',
